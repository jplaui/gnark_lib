...
// MerkleTree stores the path, the root hash and a helper for the Merkle proof.
...
// 'numLeaves' equals 0.
func (mp *MerkleTree) VerifyProof(api frontend.API, h hash.FieldHasher, leaf frontend.Variable) {
