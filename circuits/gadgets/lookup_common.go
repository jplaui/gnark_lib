...
func NewLookUpAESGadget(api frontend.API) LookUpAESGadget {
	...
	return LookUpAESGadget{api: api, sbox: sbox, RCon: RCon, t0: t0, t1: t1, t2: t2, t3: t3}
}
...
func (aes *LookUpAESGadget) Subws(sbox *logderivlookup.Table, a ...frontend.Variable) []frontend.Variable {
	return sbox.Lookup(a...)
}

func (aes *LookUpAESGadget) createIV(counter frontend.Variable, iv []frontend.Variable) {
